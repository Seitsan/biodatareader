...
Example:
    ...
    .. code-block:: bash
        ...
        python run_sam_click.py sample.sam

    Запуск с фильтрацией по региону:

    .. code-block:: bash

        python run_sam_click.py sample.sam --chrom chr1 --start 10000 --end 20000
"""
...
def main(sam_file: Path, chrom: str, start: int, end: int, verbose: bool) -> None:
    ...
    Примеры использования:
      python run_sam_click.py sample.sam
      python run_sam_click.py sample.sam --chrom chr1 --start 10000 --end 20000
      python run_sam_click.py sample.sam -c chr1 -s 10000 -e 20000 -v
    """
